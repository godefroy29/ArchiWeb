...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/a9532be')) {
            // _assetic_a9532be
            if ($pathinfo === '/css/a9532be.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'a9532be',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_a9532be',);
            }

            // _assetic_a9532be_0
            if ($pathinfo === '/css/a9532be_bootstrap_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'a9532be',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_a9532be_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/r')) {
            ...
            if ($pathinfo === '/register') {
                return array (  '_controller' => 'firstBundle\\Controller\\DefaultController::registerAction',  '_route' => 'first_register',);
            }
